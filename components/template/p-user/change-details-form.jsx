      ...
      <form className="flex flex-col items-center w-full gap-6 px-4 lg:w-6/12 w-full">
        <div className="w-full flex flex-col gap-3 moraba-regular text-lg">
          ...
          <input
            ...
            className="outline-hidden border-2 font-mono border-brown-500 px-4 py-3 w-full rounded-lg focus:border-brown-700 transition-all"
          ></input>
        </div>
        <div className="w-full flex flex-col gap-3 moraba-regular text-lg">
        ...
        <button
          ...
          className="bg-brown-500 w-full moraba-bold text-white rounded-lg py-4 hover:bg-brown-700 transition"
        >
          ذخیره تغییرات
        </button>
      </form>
